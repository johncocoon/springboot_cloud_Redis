			  ...
			  <div class="panel-body">
				<form id="form" method="post">
				  <div class="form-group">
					...
					<input type="text" class="form-control" id="name" name="name" value="${param.loginacct }" placeholder="请输入登陆账号">
				  </div>
				  <div class="form-group">
					<label for="icon">图标</label>
					<input type="text" class="form-control" id="icon" name="icon" value="${param.username }" placeholder="请输入用户名称">
				  </div>
				  <div class="form-group">
					<label for="url">地址</label>
					<input type="email" class="form-control" id="url" name="url" value="${param.email }" placeholder="请输入邮箱地址">
				  </div>
	...
	<script src="${APP_PATH }/jquery/layer/layer.js"></script>
        <script type="text/javascript">
            ...
            $("#savebtn").click(function(){
            	...
            	$.ajax({
            		type : 'post',
            		url : '${APP_PATH}/permission/savePermission.do',
            		data :{
            			name : $("#name").val(),
            			icon : $("#icon").val(),
            			url : $("#url").val(),
